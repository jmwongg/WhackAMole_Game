...
const exportExperimentLog = function () {
  let csvHeader =
    "PiD,TrailId,startTS, rndDelayStart,rndDelay,rndDelayEnd,moleXn,moleYn,moleScale,hitTime,userMoveStart,userEnterMole,userClickMole,hitSuccess,Distance,movementTime,ID\n";
